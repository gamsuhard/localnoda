...
: "${LOADER_MAX_SLOTS:=$LOADER_CONCURRENCY}"
: "${LOADER_PROFILE:=usdt_trc20}"
: "${LOADER_RECORD_BATCH_SIZE:=350000}"
: "${LOADER_BUILD_LEGS_IN_HOT_PATH:=0}"
: "${LOADER_SKIP_PER_SEGMENT_CANONICAL_COUNTS:=1}"
: "${LOADER_SEGMENT_STALE_SECONDS:=1800}"
: "${LOADER_RUNTIME_LOCK_STALE_SECONDS:=1800}"
: "${LOADER_FAILED_RETRY_BACKOFF_SECONDS:=120}"
: "${LOADER_MAX_ATTEMPTS:=5}"
: "${LOADER_SQLITE_BUSY_TIMEOUT_MS:=30000}"
...
: "${LOADER_SOURCE_STREAM_NAME:=}"
: "${LOADER_SOURCE_TRIGGER_NAME:=}"
...
LOADER_MAX_SLOTS=$LOADER_MAX_SLOTS
...
LOADER_SEGMENT_STALE_SECONDS=$LOADER_SEGMENT_STALE_SECONDS
LOADER_RUNTIME_LOCK_STALE_SECONDS=$LOADER_RUNTIME_LOCK_STALE_SECONDS
LOADER_FAILED_RETRY_BACKOFF_SECONDS=$LOADER_FAILED_RETRY_BACKOFF_SECONDS
LOADER_MAX_ATTEMPTS=$LOADER_MAX_ATTEMPTS
LOADER_SQLITE_BUSY_TIMEOUT_MS=$LOADER_SQLITE_BUSY_TIMEOUT_MS
LOADER_DB_PATH=$LOADER_DB_PATH
LOADER_SCHEMA_PATH=$LOADER_SCHEMA_PATH
AWS_REGION=$AWS_REGION
S3_BUFFER_BUCKET=$S3_BUFFER_BUCKET
S3_BUFFER_PREFIX_ROOT=$S3_BUFFER_PREFIX_ROOT
LOADER_SOURCE_STREAM_NAME=$LOADER_SOURCE_STREAM_NAME
LOADER_SOURCE_TRIGGER_NAME=$LOADER_SOURCE_TRIGGER_NAME
